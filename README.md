...
All recommend rules will be set to error by default. You can however disable some rules by turning them `off` in your `.eslintrc` file or by setting them to `warn` in your `.eslintrc`.
